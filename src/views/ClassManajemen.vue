<script>
  ...
  this.filterLocation = '';
      ...
      link.href = import.meta.env.VITE_APP_BACKEND_URL_API + '/export/peserta';
  ...
  <template>
    ...
    <div class="md:ml-12 ml-4 pt-10">
      <span class="md:text-2xl text-xl font-semibold mb-8 text-ungutext">Class Management</span>
    </div>
...
<div class="flex mt-8 md:ml-32 ml-5 md:space-x-4 space-x-2">
    ...
    <div class="p-8 md:mx-32 mx-5 bg-white rounded-lg mb-8">

<!-- Container Flex Utama -->
<div class="flex flex-wrap justify-between items-end mb-6 gap-4">

<!-- Bagian Kiri: Filter -->
<div class="flex flex-wrap gap-4 text-ungutext">
  <!-- Tanggal -->
  <div>
...
<div v-if="isLoading" class="flex justify-center items-center py-8">
  ...
  <span class="ml-2 text-gray-600 font-medium">Loading classes...</span>
      ...
      <div v-for="kelas in filteredKelasList" :key="kelas.id" class="p-3 rounded-lg shadow-xl bg-kuning mt-3 flex flex-col md:flex-row text-ungutext">
         <img
        ...
        <div class="flex flex-col justify-end items-end w-full md:w-auto mt-4 md:mt-0 mb-5 mr-8">
          ...
          <div class="flex space-x-2 mt-2 justify-center md:justify-end">
            ...
            <RouterLink :to="`/classlist/classmanajemen/detailclass/${kelas.id}`">
